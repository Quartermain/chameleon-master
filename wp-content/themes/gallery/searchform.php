...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<label class="screen-reader-text"><?php _x( 'Search for:', 'label', 'gallery' ); ?></label>
	...
	<button type="submit"><img class="sb-icon-search" src="<?php echo get_template_directory_uri(); ?>/assets/img/search-icon.svg" alt=""></button>
